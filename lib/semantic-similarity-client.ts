// Client-side wrapper for semantic similarity
// This file handles the browser environment and provides fallbacks
...
// Simple keyword-based matching for client-side fallback
...
// Client-side semantic similarity using transformers.js
export async function findMostSimilarModelClient(prompt: string): Promise<ModelDescription> {
  try {
    ...
    console.error('Client-side semantic similarity failed:', error)
    // Fallback to keyword matching
    return findModelByKeywords(prompt)
  }
}
